...
- (id)initWithDictionary:(NSDictionary *)dic
{
    ...
    if (self) {
        ...
        if ([dic objectForKey:@"img"]) {
            ...
            self.imgURL = @"https://firebasestorage.googleapis.com/v0/b/quupe-restore.appspot.com/o/images%2F1476140364491.jpg?alt=media&token=e83160df-23c3-47c9-8067-413a4425691c";
        }

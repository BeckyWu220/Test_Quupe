...
- (IBAction)calculateBtn:(id)sender {
    ...
    }else
    {
        ...
        if ([itemCategory isEqualToString:@"Electronics"]) {
            ...
            itemCategory = @"out";
        }else if ([itemCategory isEqualToString:@"Fun and Recreation"]){
            itemCategory = @"rec";
        }else if ([itemCategory isEqualToString:@"Home, Garden and Tools"]){
            itemCategory = @"hom";
        }else if ([itemCategory isEqualToString:@"Others"]){
            itemCategory = @"oth";
        }
...
{
    if (alertView.tag == signInAlert && buttonIndex == 0) {
